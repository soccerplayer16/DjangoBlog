define("ClipboardWithTooltip", ["react","react-dom","lodash","focus-tooltip-WithTooltip"], function(__WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_179__, __WEBPACK_EXTERNAL_MODULE_243__, __WEBPACK_EXTERNAL_MODULE_876__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var _clipboard = __webpack_require__(638);
...
var _withTooltip = __webpack_require__(876);
...
var _plurr = __webpack_require__(67);

var _plurr2 = _interopRequireDefault(_plurr);

var _webI18nResources = __webpack_require__(65);
...
var I18n = function () {
  ...
  _createClass(I18n, [{
    ...
    value: function L(key, plurrParams) {
      return this.localize(key, _extends({
        BOLDSTART: '<strong>',
        BOLD_START: '<strong>',
        BOLDEND: '</strong>',
        BOLD_END: '</strong>'
    ...
    value: function format(msg) {
      var plurrParams = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
/**
 * Gets a closure that localizes an i18n key with some fixed i18n prefix.
 *
 ...
 *     localized string
 */
function getLocalizer(i18nPrefix) {
  return function (suffix, args) {
    return i18n.localize(i18nPrefix + '.' + suffix, args);
  };
}
...
module.exports = __WEBPACK_EXTERNAL_MODULE_876__;
